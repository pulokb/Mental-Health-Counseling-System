...
<!-- Image Field -->
@isset($symptoms)
<img src="{{asset('images/'.$symptoms->image)}}" alt="" srcset="">
@endisset
<div class="form-group">
    <br>
...
<div class="form-group">
    ...
    <a href="{{ route('admin.symptoms.index') }}" class="btn btn-danger"><i class="fa fa-window-close" aria-hidden="true"></i> {{ __("Cancel") }}</a>
</div>
