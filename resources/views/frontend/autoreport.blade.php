...
<div class="container my-5">
                ...
                <div class="card-body text-start">
                    <div class="report-section">
                        ...
                        <div>
                            ...
                            <button class="theme-btn-1 btn btn-effect-1 text-uppercase" onclick="printReport()">Print Report</button>
                        </div>
                    </div>
    ...
    <script>
        ...
        function generateChart(ctx, score, sectionName) {
            ...
            const color = unbalanced <= 33 ? 'yellow' : unbalanced <= 66 ? 'orange' : 'red';
            new Chart(ctx, {
                type: 'pie',
                data: {
